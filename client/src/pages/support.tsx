              ...
              <div className="max-w-3xl">
                ...
                <div className="space-y-8">
                    ...
                    <ul className="space-y-4">
                      ...
                      <li className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-neutral-600">Check guest NOSTR profiles and attestations. Communicate directly with guests before confirming bookings to establish expectations.</p>
                        </div>
                      </li>
                      ...
                      <li className="flex">
                        <i className="ri-check-line text-xl text-green-600 mr-3 mt-0.5"></i>
                        <div>
                          <h4 className="font-bold">Clear Rules</h4>
                          <p className="text-neutral-600">Establish clear house rules and communicate them to guests before their stay. Include these rules in your listing description for transparency.</p>
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-neutral-50 p-6 rounded-lg">
                    <h3 className="text-lg font-bold mb-3">Report a Safety Concern</h3>
                    <p className="text-neutral-600 mb-4">
                      If you encounter any safety issues during your stay or with a guest, please report it immediately.
                    </p>
                    <Button asChild>
              ...
              <div className="max-w-3xl">
                ...
                <div className="space-y-8">
                  <p className="text-neutral-600">
                    At restr, hosts set their own cancellation policies. When booking a property, you'll see one of 
                    these policies applied to your reservation. Make sure to review the policy before booking.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="border border-neutral-200 rounded-lg p-6">
                      <div className="flex items-center mb-4">
                        <div className="bg-green-100 w-12 h-12 rounded-full flex items-center justify-center mr-4">
                          <i className="ri-bank-card-line text-xl text-green-600"></i>
                        </div>
                        <h3 className="text-lg font-bold">Flexible</h3>
                      </div>
                      <ul className="text-sm text-neutral-600 space-y-2">
                        <li><strong>Full refund:</strong> Cancel up to 48 hours before check-in</li>
                        <li><strong>Partial refund:</strong> 50% refund between 48 hours and 24 hours before check-in</li>
                    ...
                    <div className="border border-neutral-200 rounded-lg p-6">
                      ...
                      <ul className="text-sm text-neutral-600 space-y-2">
                        ...
                        <li><strong>Partial refund:</strong> 50% refund between 5 days and 48 hours before check-in</li>
                        <li><strong>No refund:</strong> Less than 48 hours before check-in</li>
                      </ul>
                    </div>
                    ...
                    <div className="border border-neutral-200 rounded-lg p-6">
                      ...
                      <ul className="text-sm text-neutral-600 space-y-2">
                        <li><strong>Full refund:</strong> Cancel within 48 hours of booking and at least 14 days before check-in</li>
                        <li><strong>Partial refund:</strong> 50% refund up to 7 days before check-in</li>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-5 rounded">
                    <h3 className="text-lg font-bold text-blue-700 mb-2">Special Circumstances</h3>
                    <p className="text-neutral-700 mb-4">
                      Cancellations may qualify for a full refund regardless of the host's policy in these situations:
                    </p>
                    <ul className="list-disc pl-5 space-y-1 text-neutral-700">
                      <li>Serious illness or injury for you or a co-host</li>
                      <li>Death of a host, guest, or immediate family member</li>
                      <li>Natural disasters or severe weather incidents that prevent travel</li>
                      <li>Urgent travel restrictions or government obligations</li>
                      <li>Property safety issues that the host cannot resolve</li>
                    </ul>
                  </div>
                  
                  <div className="border-t border-neutral-200 pt-6">
                    <h3 className="text-xl font-bold mb-4">How to Cancel a Reservation</h3>
                    <ol className="list-decimal pl-5 space-y-2 mb-4 text-neutral-600">
