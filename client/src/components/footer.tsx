        ...
        <div className="border-t border-neutral-200 pt-6 mt-6 flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://twitter.com/nostr_protocol" target="_blank" rel="noopener noreferrer" className="text-neutral-600 hover:text-primary">
                <i className="ri-twitter-x-fill text-lg"></i>
              </a>
              <a href="https://discord.com/invite/nostr" target="_blank" rel="noopener noreferrer" className="text-neutral-600 hover:text-primary">
